...
pub struct UmPositionAdlQuantileEstimationResponseInnerAdlQuantile {
...
impl UmPositionAdlQuantileEstimationResponseInnerAdlQuantile {
    #[must_use]
    pub fn new() -> UmPositionAdlQuantileEstimationResponseInnerAdlQuantile {
