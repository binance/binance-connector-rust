...
pub struct QueryAllCurrentUmOpenAlgoOrdersResponseInner {
...
impl QueryAllCurrentUmOpenAlgoOrdersResponseInner {
    #[must_use]
    pub fn new() -> QueryAllCurrentUmOpenAlgoOrdersResponseInner {
