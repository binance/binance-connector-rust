...
pub struct QueryLiquidationLoanRepayHistoryResponseRowsInner {
...
impl QueryLiquidationLoanRepayHistoryResponseRowsInner {
    #[must_use]
    pub fn new() -> QueryLiquidationLoanRepayHistoryResponseRowsInner {
