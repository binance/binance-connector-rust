...
pub struct QueryLiquidationLoanRepayHistoryResponse {
    ...
    pub rows: Option<Vec<models::QueryLiquidationLoanRepayHistoryResponseRowsInner>>,
}

impl QueryLiquidationLoanRepayHistoryResponse {
    #[must_use]
    pub fn new() -> QueryLiquidationLoanRepayHistoryResponse {
