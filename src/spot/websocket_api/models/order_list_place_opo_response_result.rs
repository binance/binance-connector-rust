...
pub struct OrderListPlaceOpoResponseResult {
    ...
    pub orders: Option<Vec<models::OrderListPlaceOpoResponseResultOrdersInner>>,
    #[serde(rename = "orderReports", skip_serializing_if = "Option::is_none")]
    pub order_reports: Option<Vec<models::OrderListPlaceOpoResponseResultOrderReportsInner>>,
}

impl OrderListPlaceOpoResponseResult {
    #[must_use]
    pub fn new() -> OrderListPlaceOpoResponseResult {
