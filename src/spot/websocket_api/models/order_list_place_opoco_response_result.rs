...
pub struct OrderListPlaceOpocoResponseResult {
    ...
    pub orders: Option<Vec<models::OrderListPlaceOpocoResponseResultOrdersInner>>,
    #[serde(rename = "orderReports", skip_serializing_if = "Option::is_none")]
    pub order_reports: Option<Vec<models::OrderListPlaceOpocoResponseResultOrderReportsInner>>,
}

impl OrderListPlaceOpocoResponseResult {
    #[must_use]
    pub fn new() -> OrderListPlaceOpocoResponseResult {
