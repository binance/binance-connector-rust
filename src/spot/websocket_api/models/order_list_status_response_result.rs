...
pub struct OrderListStatusResponseResult {
    ...
    pub orders: Option<Vec<models::AllOrderListsResponseResultInnerOrdersInner>>,
}

impl OrderListStatusResponseResult {
    #[must_use]
    pub fn new() -> OrderListStatusResponseResult {
