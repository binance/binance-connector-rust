...
pub struct OrderListPlaceOpocoResponseResultOrderReportsInner {
...
impl OrderListPlaceOpocoResponseResultOrderReportsInner {
    #[must_use]
    pub fn new() -> OrderListPlaceOpocoResponseResultOrderReportsInner {
