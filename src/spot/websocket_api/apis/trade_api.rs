 ...
 *
 *
 * The version of the OpenAPI document: Decimal::ONE.0
 *
 *
...
mod tests {
    ...
    fn order_amend_keep_priority_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let handle = spawn(async move {
                let params = OrderAmendKeepPriorityParams::builder("BNBUSDT".to_string(), Decimal::ONE,).build().unwrap();
    ...
    fn order_amend_keep_priority_request_timeout() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let handle = spawn(async move {
                let params =
                    OrderAmendKeepPriorityParams::builder("BNBUSDT".to_string(), Decimal::ONE)
                        .build()
                        .unwrap();
                client.order_amend_keep_priority(params).await
            });
    ...
    fn order_list_place_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let handle = spawn(async move {
                let params = OrderListPlaceParams::builder("BNBUSDT".to_string(),OrderListPlaceSideEnum::Buy,Decimal::ONE, Decimal::ONE,).build().unwrap();
    ...
    fn order_list_place_oco_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let handle = spawn(async move {
                let params = OrderListPlaceOcoParams::builder("BNBUSDT".to_string(),OrderListPlaceOcoSideEnum::Buy,Decimal::ONE,OrderListPlaceOcoAboveTypeEnum::StopLossLimit,OrderListPlaceOcoBelowTypeEnum::StopLoss,).build().unwrap();
            ...
            let mut resp_json: Value = serde_json::from_str(r#"{"id":"56374a46-3261-486b-a211-99ed972eb648","status":200,"result":{"orderListId":2,"contingencyType":"OCO","listStatusType":"EXEC_STARTED","listOrderStatus":"EXECUTING","listClientOrderId":"cKPMnDCbcLQILtDYM4f4fX","transactionTime":1711062760648,"symbol":"LTCBNB","orders":[{"symbol":"LTCBNB","orderId":3,"clientOrderId":"Z2IMlR79XNY5LU0tOxrWyW"},{"symbol":"LTCBNB","orderId":2,"clientOrderId":"0m6I4wfxvTUrOBSMUl0OPU"}],"orderReports":[{"symbol":"LTCBNB","orderId":3,"orderListId":2,"clientOrderId":"Z2IMlR79XNY5LU0tOxrWyW","transactTime":1711062760648,"price":"1.49999999","origQty":"Decimal::ONE00000","executedQty":"0.000000","origQuoteOrderQty":"0.000000","cummulativeQuoteQty":"0.00000000","status":"NEW","timeInForce":"GTC","type":"LIMIT_MAKER","side":"BUY","workingTime":1711062760648,"selfTradePreventionMode":"NONE"},{"symbol":"LTCBNB","orderId":2,"orderListId":2,"clientOrderId":"0m6I4wfxvTUrOBSMUl0OPU","transactTime":1711062760648,"price":"1.50000000","origQty":"Decimal::ONE00000","executedQty":"0.000000","origQuoteOrderQty":"0.000000","cummulativeQuoteQty":"0.00000000","status":"NEW","timeInForce":"GTC","type":"STOP_LOSS_LIMIT","side":"BUY","stopPrice":"1.50000001","workingTime":-1,"selfTradePreventionMode":"NONE"}]},"rateLimits":[{"rateLimitType":"REQUEST_WEIGHT","interval":"MINUTE","intervalNum":1,"limit":6000,"count":1},{"rateLimitType":"ORDERS","interval":"DAY","intervalNum":1,"limit":160000,"count":2},{"rateLimitType":"ORDERS","interval":"SECOND","intervalNum":10,"limit":50,"count":2}]}"#).unwrap();
            resp_json["id"] = id.into();
    ...
    fn order_list_place_oto_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let handle = spawn(async move {
                let params = OrderListPlaceOtoParams::builder("BNBUSDT".to_string(),OrderListPlaceOtoWorkingTypeEnum::Limit,OrderListPlaceOtoWorkingSideEnum::Buy,Decimal::ONE,Decimal::ONE,OrderListPlaceOtoPendingTypeEnum::Limit,OrderListPlaceOtoPendingSideEnum::Buy,Decimal::ONE,).build().unwrap();
    ...
    fn order_list_place_otoco_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let handle = spawn(async move {
                let params = OrderListPlaceOtocoParams::builder("BNBUSDT".to_string(),OrderListPlaceOtocoWorkingTypeEnum::Limit,OrderListPlaceOtocoWorkingSideEnum::Buy,Decimal::ONE,Decimal::ONE,OrderListPlaceOtocoPendingSideEnum::Buy,Decimal::ONE,OrderListPlaceOtocoPendingAboveTypeEnum::StopLossLimit,).build().unwrap();
    ...
    fn sor_order_place_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let handle = spawn(async move {
                let params = SorOrderPlaceParams::builder("BNBUSDT".to_string(),SorOrderPlaceSideEnum::Buy,SorOrderPlaceTypeEnum::Market,Decimal::ONE,).build().unwrap();
