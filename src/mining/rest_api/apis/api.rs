...
impl HashrateResaleRequestParams {
    ...
    /// * `user_name` — Mining Account
    /// * `algo` — Transfer algorithm
    /// * `end_date` — Resale End Time (Millisecond timestamp)
    /// * `start_date` — Resale Start Time(Millisecond timestamp)
...
mod tests {
    ...
    impl Api for MockApiClient {
        async fn account_list(
            ...
            let resp_json: Value = serde_json::from_str(r#"{"code":0,"msg":"","data":[{"type":"H_hashrate","userName":"test","list":[{"time":1585267200000,"hashrate":"0.00000000","reject":"0.00000000"}]}]}"#).unwrap_or_else(|_| serde_json::json!({}));
        ...
        async fn acquiring_algorithm(
            ...
            let resp_json: Value = serde_json::from_str(r#"{"code":0,"msg":"","data":[{"algoName":"SHA256-BTC","algoId":1,"poolIndex":100,"unit":"h/s"}]}"#).unwrap_or_else(|_| serde_json::json!({}));
        ...
        async fn acquiring_coinname(
            ...
            let resp_json: Value = serde_json::from_str(r#"{"code":0,"msg":"","data":[{"coinName":"BTC","coinId":1,"poolIndex":0,"algoId":1,"algoName":"SHA256-BTC"}]}"#).unwrap_or_else(|_| serde_json::json!({}));
        ...
        ) -> anyhow::Result<RestApiResponse<models::CancelHashrateResaleConfigurationResponse>>
        {
            ...
            let resp_json: Value = serde_json::from_str(r#"{"code":0,"msg":"","data":true}"#)
        ...
        async fn earnings_list(
            ...
            let resp_json: Value = serde_json::from_str(r#"{"code":0,"msg":"","data":{"accountProfits":[{"time":1586188800000,"type":31,"hashTransfer":200000000000,"transferAmount":0.02180958,"dayHashRate":129129903378244,"profitAmount":8.6083060304,"coinName":"BTC","status":2}],"totalNum":3,"pageSize":20}}"#).unwrap_or_else(|_| serde_json::json!({}));
        ...
        async fn extra_bonus_list(
            ...
            let resp_json: Value = serde_json::from_str(r#"{"code":0,"msg":"","data":{"otherProfits":[{"time":1607443200000,"coinName":"BTC","type":4,"profitAmount":0.0011859,"status":2}],"totalNum":3,"pageSize":20}}"#).unwrap_or_else(|_| serde_json::json!({}));
        ...
        async fn hashrate_resale_detail(
            ...
            let resp_json: Value = serde_json::from_str(r#"{"code":0,"msg":"","data":{"profitTransferDetails":[{"poolUsername":"test4001","toPoolUsername":"pop","algoName":"sha256","hashRate":200000000000,"day":20201213,"amount":0.2256872,"coinName":"BTC"}],"totalNum":8,"pageSize":200}}"#).unwrap_or_else(|_| serde_json::json!({}));
        ...
        async fn hashrate_resale_list(
            ...
            let resp_json: Value = serde_json::from_str(r#"{"code":0,"msg":"","data":{"configDetails":[{"configId":168,"poolUsername":"123","toPoolUsername":"user1","algoName":"Ethash","hashRate":5000000,"startDay":20201210,"endDay":20210405,"status":1,"type":0}],"totalNum":21,"pageSize":200}}"#).unwrap_or_else(|_| serde_json::json!({}));
        ...
        async fn hashrate_resale_request(
            ...
            let resp_json: Value = serde_json::from_str(r#"{"code":0,"msg":"","data":171}"#)
                .unwrap_or_else(|_| serde_json::json!({}));
        ...
        async fn mining_account_earning(
            ...
            let resp_json: Value = serde_json::from_str(r#"{"code":0,"msg":"","data":{"accountProfits":[{"time":1607443200000,"coinName":"BTC","type":2,"puid":59985472,"subName":"vdvaghani","amount":0.09186957}],"totalNum":3,"pageSize":20}}"#).unwrap_or_else(|_| serde_json::json!({}));
        ...
        async fn request_for_detail_miner_list(
            ...
            let resp_json: Value = serde_json::from_str(r#"{"code":0,"msg":"","data":[{"workerName":"bhdc1.16A10404B","type":"H_hashrate","hashrateDatas":[{"time":1587902400000,"hashrate":"0","reject":0}]}]}"#).unwrap_or_else(|_| serde_json::json!({}));
        ...
        async fn request_for_miner_list(
            ...
            let resp_json: Value = serde_json::from_str(r#"{"code":0,"msg":"","data":{"workerDatas":[{"workerId":"1420554439452400131","workerName":"2X73","status":3,"hashRate":0,"dayHashRate":1.269778129801366E13,"rejectRate":0,"lastShareTime":1587712919000}],"totalNum":18530,"pageSize":20}}"#).unwrap_or_else(|_| serde_json::json!({}));
    ...
    fn account_list_required_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            let client = MockApiClient { force_error: false };

            let params = AccountListParams::builder("sha256".to_string(),"test".to_string(),).build().unwrap();
    ...
    fn account_list_optional_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = AccountListParams::builder("sha256".to_string(),"test".to_string(),).recv_window(5000).build().unwrap();
    ...
    fn account_list_response_error() {
        TOKIO_SHARED_RT.block_on(async {
            let client = MockApiClient { force_error: true };

            let params = AccountListParams::builder("sha256".to_string(), "test".to_string())
                .build()
                .unwrap();
    ...
    fn cancel_hashrate_resale_configuration_required_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = CancelHashrateResaleConfigurationParams::builder(168, "test".to_string())
                .build()
                .unwrap();
    ...
    fn earnings_list_required_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = EarningsListParams::builder("sha256".to_string(),"test".to_string(),).build().unwrap();
    ...
    fn earnings_list_optional_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = EarningsListParams::builder("sha256".to_string(),"test".to_string(),).coin("BTC".to_string()).start_date(1770736694138).end_date(1770736694138).page_index(1).page_size(10).recv_window(5000).build().unwrap();
    ...
    fn earnings_list_response_error() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = EarningsListParams::builder("sha256".to_string(), "test".to_string())
                .build()
                .unwrap();
    ...
    fn extra_bonus_list_required_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = ExtraBonusListParams::builder("sha256".to_string(),"test".to_string(),).build().unwrap();
    ...
    fn extra_bonus_list_optional_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = ExtraBonusListParams::builder("sha256".to_string(),"test".to_string(),).coin("BTC".to_string()).start_date(1770736694138).end_date(1770736694138).page_index(1).page_size(10).recv_window(5000).build().unwrap();
    ...
    fn extra_bonus_list_response_error() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = ExtraBonusListParams::builder("sha256".to_string(), "test".to_string())
                .build()
                .unwrap();
    ...
    fn hashrate_resale_detail_required_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = HashrateResaleDetailParams::builder(168,).build().unwrap();
    ...
    fn hashrate_resale_detail_optional_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = HashrateResaleDetailParams::builder(168,).page_index(1).page_size(10).recv_window(5000).build().unwrap();
    ...
    fn hashrate_resale_list_optional_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = HashrateResaleListParams::builder().page_index(1).page_size(10).recv_window(5000).build().unwrap();
    ...
    fn mining_account_earning_required_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = MiningAccountEarningParams::builder("sha256".to_string(),).build().unwrap();
    ...
    fn mining_account_earning_optional_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = MiningAccountEarningParams::builder("sha256".to_string(),).start_date(1770736694138).end_date(1770736694138).page_index(1).page_size(10).recv_window(5000).build().unwrap();
    ...
    fn mining_account_earning_response_error() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = MiningAccountEarningParams::builder("sha256".to_string())
                .build()
                .unwrap();
    ...
    fn request_for_detail_miner_list_required_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = RequestForDetailMinerListParams::builder("sha256".to_string(),"test".to_string(),"bhdc1.16A10404B".to_string(),).build().unwrap();
    ...
    fn request_for_detail_miner_list_optional_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = RequestForDetailMinerListParams::builder("sha256".to_string(),"test".to_string(),"bhdc1.16A10404B".to_string(),).recv_window(5000).build().unwrap();
    ...
    fn request_for_miner_list_required_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = RequestForMinerListParams::builder("sha256".to_string(),"test".to_string(),).build().unwrap();
    ...
    fn request_for_miner_list_optional_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = RequestForMinerListParams::builder("sha256".to_string(),"test".to_string(),).page_index(1).sort(0).sort_column(1).worker_status(0).recv_window(5000).build().unwrap();
    ...
    fn request_for_miner_list_response_error() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params =
                RequestForMinerListParams::builder("sha256".to_string(), "test".to_string())
                    .build()
                    .unwrap();
    ...
    fn statistic_list_required_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = StatisticListParams::builder("sha256".to_string(),"test".to_string(),).build().unwrap();
    ...
    fn statistic_list_optional_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = StatisticListParams::builder("sha256".to_string(),"test".to_string(),).recv_window(5000).build().unwrap();
    ...
    fn statistic_list_response_error() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = StatisticListParams::builder("sha256".to_string(), "test".to_string())
                .build()
                .unwrap();
