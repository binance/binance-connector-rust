...
pub struct GetMarketDetailResponse {
    ...
    #[serde(rename = "variantData", skip_serializing_if = "Option::is_none")]
    pub variant_data: Option<Box<models::GetMarketDetailResponseVariantData>>,
    ...
    pub timeline: Option<Vec<models::GetMarketDetailResponseTimelineInner>>,
    #[serde(rename = "markets", skip_serializing_if = "Option::is_none")]
    pub markets: Option<Vec<models::GetMarketDetailResponseMarketsInner>>,
}

impl GetMarketDetailResponse {
    #[must_use]
    pub fn new() -> GetMarketDetailResponse {
