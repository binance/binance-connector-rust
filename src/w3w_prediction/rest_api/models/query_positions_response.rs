...
pub struct QueryPositionsResponse {
    ...
    pub summary: Option<Box<models::QueryPositionsResponseSummary>>,
    #[serde(rename = "counts", skip_serializing_if = "Option::is_none")]
    pub counts: Option<Box<models::QueryPositionsResponseCounts>>,
    #[serde(rename = "positions", skip_serializing_if = "Option::is_none")]
    pub positions: Option<Vec<models::QueryPositionsResponsePositionsInner>>,
}
