...
pub struct QueryPositionsByFilterResponsePositionsInner {
...
impl QueryPositionsByFilterResponsePositionsInner {
    #[must_use]
    pub fn new() -> QueryPositionsByFilterResponsePositionsInner {
