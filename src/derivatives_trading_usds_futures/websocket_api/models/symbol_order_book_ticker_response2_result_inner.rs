...
pub struct SymbolOrderBookTickerResponse2ResultInner {
...
impl SymbolOrderBookTickerResponse2ResultInner {
    #[must_use]
    pub fn new() -> SymbolOrderBookTickerResponse2ResultInner {
