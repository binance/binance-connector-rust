...
pub struct GetFuturesPositionRiskOfSubAccountResponseInner {
...
impl GetFuturesPositionRiskOfSubAccountResponseInner {
    #[must_use]
    pub fn new() -> GetFuturesPositionRiskOfSubAccountResponseInner {
