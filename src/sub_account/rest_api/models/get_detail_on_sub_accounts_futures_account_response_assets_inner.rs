...
pub struct GetDetailOnSubAccountsFuturesAccountResponseAssetsInner {
...
impl GetDetailOnSubAccountsFuturesAccountResponseAssetsInner {
    #[must_use]
    pub fn new() -> GetDetailOnSubAccountsFuturesAccountResponseAssetsInner {
