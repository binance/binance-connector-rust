...
pub struct GetSummaryOfSubAccountsFuturesAccountResponseSubAccountListInner {
...
impl GetSummaryOfSubAccountsFuturesAccountResponseSubAccountListInner {
    #[must_use]
    pub fn new() -> GetSummaryOfSubAccountsFuturesAccountResponseSubAccountListInner {
