...
pub enum DepositApiPaymentMethodEnum {
    #[serde(rename = "pix")]
    Pix,
}

impl DepositApiPaymentMethodEnum {
    #[must_use]
...
impl std::str::FromStr for DepositApiPaymentMethodEnum {
    type Err = Box<dyn std::error::Error + Send + Sync>;

    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "pix" => Ok(Self::Pix),
            other => Err(format!("invalid DepositApiPaymentMethodEnum: {}", other).into()),
        }
    }
}
...
#[allow(non_camel_case_types)]
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum FiatWithdrawApiPaymentMethodEnum {
    #[serde(rename = "bank_transfer")]
    BankTransfer,
}

impl FiatWithdrawApiPaymentMethodEnum {
    #[must_use]
    pub fn as_str(&self) -> &'static str {
        match self {
...
impl std::str::FromStr for FiatWithdrawApiPaymentMethodEnum {
    type Err = Box<dyn std::error::Error + Send + Sync>;

    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "bank_transfer" => Ok(Self::BankTransfer),
            other => Err(format!("invalid FiatWithdrawApiPaymentMethodEnum: {}", other).into()),
        }
    }
}
...
pub struct DepositParams {
    ...
    /// This field is **required.
    #[builder(setter(into))]
    #[serde(rename = "apiPaymentMethod")]
    pub api_payment_method: DepositApiPaymentMethodEnum,
    /// deposit amount
    ///
    /// This field is **required.
    #[builder(setter(into))]
...
impl DepositParams {
    ...
    ///
    /// * `currency` — String
    /// * `api_payment_method` — payment method; current supported: pix
...
pub struct FiatWithdrawParams {
    ...
    #[builder(setter(into))]
    #[serde(rename = "apiPaymentMethod")]
    pub api_payment_method: FiatWithdrawApiPaymentMethodEnum,
    /// withdraw amount
    ///
    /// This field is **required.
    #[builder(setter(into))]
    ...
    pub account_info: models::FiatWithdrawRequestAccountInfo,
    /// Request validity window in milliseconds
    ///
    /// This field is **optional.
    #[builder(setter(into), default)]
...
impl FiatWithdrawParams {
    ...
    /// Required parameters:
    ///
    /// * `currency` — Fiat currency, such as BRL, ARS, MXN
    /// * `api_payment_method` — payment method; current supported: `bank_transfer`
    /// * `amount` — withdraw amount
    /// * `account_info` — `models::FiatWithdrawRequestAccountInfo`
    ///
    #[must_use]
    pub fn builder(
        currency: String,
...
impl GetOrderDetailParams {
    ...
    /// Required parameters:
    ///
    /// * `order_no` — Order ID retrieved from the withdrawal API
    ///
    #[must_use]
...
mod tests {
    ...
    impl Api for MockApiClient {
        ...
        ) -> anyhow::Result<RestApiResponse<models::GetFiatDepositWithdrawHistoryResponse>>
        {
            ...
            let resp_json: Value = serde_json::from_str(r#"{"code":"000000","message":"success","data":[{"orderNo":"7d76d611-0568-4f43-afb6-24cac7767365","fiatCurrency":"BRL","indicatedAmount":"10.00","amount":"10.00","totalFee":"0.00","method":"BankAccount","status":"Expired","createTime":1626144956000,"updateTime":1626400907000}],"total":1,"success":true}"#).unwrap_or_else(|_| serde_json::json!({}));
        ...
        async fn get_order_detail(
            ...
            let resp_json: Value = serde_json::from_str(r#"{"code":"000000","message":"success","data":{"orderId":"036752*678","orderStatus":"ORDER_INITIAL","amount":"4.33","fee":"0.43","fiatCurrency":"***","errorCode":"","errorMessage":"","ext":{}}}"#).unwrap_or_else(|_| serde_json::json!({}));
    ...
    fn fiat_withdraw_required_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = FiatWithdrawParams::builder(
                ...
                789,
                models::FiatWithdrawRequestAccountInfo::default(),
            )
            .build()
            .unwrap();
    ...
    fn get_fiat_deposit_withdraw_history_required_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = GetFiatDepositWithdrawHistoryParams::builder("0".to_string(),).build().unwrap();
    ...
    fn get_fiat_deposit_withdraw_history_optional_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = GetFiatDepositWithdrawHistoryParams::builder("0".to_string(),).begin_time(1641782889000).end_time(1641782889000).page(1).rows(100).recv_window(5000).build().unwrap();
    ...
    fn get_fiat_deposit_withdraw_history_response_error() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = GetFiatDepositWithdrawHistoryParams::builder("0".to_string())
                .build()
                .unwrap();
    ...
    fn get_fiat_payments_history_required_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = GetFiatPaymentsHistoryParams::builder("0".to_string(),).build().unwrap();
    ...
    fn get_fiat_payments_history_optional_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = GetFiatPaymentsHistoryParams::builder("0".to_string(),).begin_time(1641782889000).end_time(1641782889000).page(1).rows(100).recv_window(5000).build().unwrap();
    ...
    fn get_fiat_payments_history_response_error() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = GetFiatPaymentsHistoryParams::builder("0".to_string())
                .build()
                .unwrap();
    ...
    fn get_order_detail_required_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = GetOrderDetailParams::builder("036752*678".to_string(),).build().unwrap();
    ...
    fn get_order_detail_optional_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = GetOrderDetailParams::builder("036752*678".to_string(),).recv_window(5000).build().unwrap();
    ...
    fn get_order_detail_response_error() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = GetOrderDetailParams::builder("036752*678".to_string())
                .build()
                .unwrap();
