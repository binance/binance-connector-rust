...
pub enum GetC2CTradeHistoryTradeTypeEnum {
    #[serde(rename = "BUY")]
    Buy,
    #[serde(rename = "SELL")]
    Sell,
...
impl GetC2CTradeHistoryTradeTypeEnum {
    #[must_use]
...
impl std::str::FromStr for GetC2CTradeHistoryTradeTypeEnum {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "BUY" => Ok(Self::Buy),
            "SELL" => Ok(Self::Sell),
            other => Err(format!("invalid GetC2CTradeHistoryTradeTypeEnum: {}", other).into()),
        }
    }
}
...
pub struct GetC2CTradeHistoryParams {
    ...
    #[serde(rename = "tradeType", default)]
    pub trade_type: Option<GetC2CTradeHistoryTradeTypeEnum>,
    ///
...
mod tests {
    ...
    fn get_c2_c_trade_history_optional_params_success() {
        TOKIO_SHARED_RT.block_on(async {
            ...
            let params = GetC2CTradeHistoryParams::builder().trade_type(GetC2CTradeHistoryTradeTypeEnum::Buy).start_timestamp(1770736694138).end_timestamp(1770736694138).page(1).rows(100).build().unwrap();
