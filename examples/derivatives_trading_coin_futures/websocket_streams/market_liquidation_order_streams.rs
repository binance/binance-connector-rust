...
use binance_sdk::derivatives_trading_coin_futures::{
    DerivativesTradingCoinFuturesWsStreams, websocket_streams::MarketLiquidationOrderStreamsParams,
};
...
async fn main() -> Result<()> {
    ...
    let params = MarketLiquidationOrderStreamsParams::builder("btcusdt".to_string()).build()?;
