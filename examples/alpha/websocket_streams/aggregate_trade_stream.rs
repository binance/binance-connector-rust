...
use binance_sdk::alpha::{AlphaWsStreams, websocket_streams::AggregateTradeStreamParams};
...
async fn main() -> Result<()> {
    ...
    let params = AggregateTradeStreamParams::builder("alpha_116usdt".to_string()).build()?;
